...
import { ref } from 'vue'
  export default {
      ...
      function getOffset(el) {
        ...
        function drawLine(div1, div2, color, thickness, leftOffset) {
          console.log(div1,div2)
            ...
            // make hr
            var htmlLine = "<div class='htmlline' style='padding:0px; z-index: 0; margin:0px; height:" + thickness + "px; background-color:" + color + "; line-height:1px; position:absolute; left:" + cx + "px; top:" + cy + "px; width:" + length + "px; -moz-transform:rotate(" + angle + "deg); -webkit-transform:rotate(" + angle + "deg); -o-transform:rotate(" + angle + "deg); -ms-transform:rotate(" + angle + "deg); transform:rotate(" + angle + "deg);' />";
    ...
    mounted() {
          ...
          this.drawLine(this.divs[0], this.divs[2], '#9251ac', this.thickness, this.leftOffset);
